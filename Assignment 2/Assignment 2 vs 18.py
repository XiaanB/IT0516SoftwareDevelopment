...
while True:
    ...
    if user_selection == 1:
        ...
        # add code to handle if the user enters a ticket number that is not in the system
        # or and invalid number
        ...
        ticket_list[s].it_response = original_it_response, input("Please provide a reason for opening this ticket: \n")
        obj.display(ticket_list[s])
        # add code to handle if the user enters a ticket number that is not in the system
        # or and invalid number
        # add code to stop the IT user from closing a closed ticket, password change
