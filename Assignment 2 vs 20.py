...
class Ticket:
    ...
    # Function to search through the ticket objects in the ticket list.
    ...
    def password_change_method(self):
        ...
        password_user_id = self.user_id[0:2]
        password_user_name = self.first_name[0:3]
    ...
    def ticket_stats(self):
        ...
        percentage_closed = round(((closed_ticket_counter/total_tickets)*100), 2)
        percentage_open = round(((open_tickets_counter/total_tickets)*100), 2)
        percentage_rework = round(((reopened_ticket_counter/total_tickets)*100), 2)
...
# Function to validate the user input when searching for a ticket
...
# Main program
def main(ticket_open_new_counter=0, number=0, ticket_closed_new_close_counter=0):
    while True:
        menu()
        user_selection = " "
        try:
        ...
        number += 1
        # The user enters the user details. The ticket gets the default values for status and response.
        # If the user enters password change as problem a new password is generated.
        if user_selection == 1:
        ...
        # The user can search for a specific ticket by number.
        ...
        # It can respond to a ticket. The ticket will close after the response.
        ...
        # This will print out the ticket stats. I have left in 2 different ways to do this.
        # in the first way it also calculates the percentages.
        ...
        # Here you can re-open a closed ticket and give a reason why. This reason is added to the reason.
